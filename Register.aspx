...
<div class="w3layouts-main">
	<h2>Register Now</h2>
        ...
        <asp:TextBox ID="TextBox1" runat="server" class="ggg" name="Name" placeholder="NAME" required=""></asp:TextBox>
			
        <asp:TextBox ID="TextBox2" runat="server" class="ggg" name="Email" placeholder="E-MAIL" required=""></asp:TextBox>
			
        <%--<asp:TextBox ID="TextBox3" runat="server" class="ggg" name="Phone" placeholder="PHONE" required=""></asp:TextBox>--%>
			
        <asp:TextBox ID="TextBox3" runat="server" class="ggg" name="Password" placeholder="PASSWORD" required=""></asp:TextBox>
