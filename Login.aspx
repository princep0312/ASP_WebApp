<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Dashboard" %>
...
<div class="w3layouts-main">
	<h2>Sign In Now</h2>
        ...
        <asp:TextBox ID="TextBox1" class="ggg" placeholder="E-MAIL" required="" runat="server"></asp:TextBox>
        <asp:TextBox ID="TextBox2" class="ggg" placeholder="PASSWORD" required="" runat="server"></asp:TextBox>
